...
const LOCALES = {
  ...
  ja: {
    ...
    save: "保存",
    settings_show_fertility: "妊娠可能性の推定を表示",
    settings_show_fertility_hint:
      "カレンダーに推定妊娠可能日と排卵日を表示し、統計に妊娠可能日数を表示します。",
    settings_show_cycle_timeline: "周期フェーズのタイムラインを表示",
    settings_show_cycle_timeline_hint:
      "月経期、卵胞期、排卵期、黄体期を表示します。オフにすると、シンプルな周期進捗タイムラインになります。",
    ...
    drive_disconnect_tap_again: "もう一度タップして確認",
    ...
    drive_sync_not_connected:
      "Google Drive に未接続です。先に接続してください。",
    drive_sync_not_unlocked: "先に PIN でロック解除してください。",
    ...
    log_delete_message: "この日の経血量、痛み、気分、メモが削除されます。",
    log_entry_deleted: "記録を削除しました",
    log_saved: "保存済み ✓",
    log_saving: "保存中…",
    log_estimated_flow: "推定された少量の経血です。値を選んで確定してください。",
    print_options_title: "生理履歴を印刷",
    print_options_intro: "日付と期間は常に含まれます。その他の情報は任意です。",
    print_options_symptoms: "症状の詳細を含める",
    print_options_symptoms_hint: "経血量、痛み、気分の概要",
    print_options_notes: "メモを含める",
    print_options_notes_hint: "非公開の日々のメモ",
    continue: "続ける",
  ...
  "zh-TW": {
    ...
    history_daily_pattern: "每日記錄：經血量、疼痛與心情",
    ...
    save: "儲存",
    settings_show_fertility: "顯示生育力估算",
    settings_show_fertility_hint:
      "在日曆中顯示預估可孕日與排卵日，並在統計中顯示可孕天數。",
    settings_show_cycle_timeline: "顯示週期階段時間軸",
    settings_show_cycle_timeline_hint:
      "顯示月經期、卵泡期、排卵期與黃體期。關閉後會改為簡化的週期進度時間軸。",
    ...
    drive_disconnect_tap_again: "再按一次以確認中斷",
    ...
    log_delete_message: "此日期的流量、疼痛、心情和備註將被刪除。",
    log_entry_deleted: "記錄已刪除",
    log_saved: "已儲存 ✓",
    log_saving: "儲存中…",
    log_estimated_flow: "預估為少量經血；請選擇數值以確認。",
    print_options_title: "列印經期歷史",
    print_options_intro: "日期與持續時間一律包含；其他資料可自行選擇。",
    print_options_symptoms: "包含症狀詳細資料",
    print_options_symptoms_hint: "流量、疼痛與心情摘要",
    print_options_notes: "包含備註",
    print_options_notes_hint: "您的私人每日備註",
    continue: "繼續",
